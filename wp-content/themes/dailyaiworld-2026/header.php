...
<header class="site-header">
    <div class="container header-inner">
        <a href="<?php echo esc_url(home_url('/')); ?>" class="brand-logo">
            <span class="logo-dot"></span> <span>Daily AI World</span> <span class="brand-year">2026</span>
        </a>
        ...
        <nav class="nav-links" id="mainNav">
            <a href="<?php echo esc_url(home_url('/explore')); ?>">Workflows</a>
            <a href="<?php echo esc_url(home_url('/explore')); ?>">MCP Registry</a>
