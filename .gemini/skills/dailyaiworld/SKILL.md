...
5. **Token Efficiency Guarantee**:
   - Use programmatic validation scripts first (`python3 audit_dispatches.py`). The AI subagent is ONLY invoked if formatting corrections are required, avoiding unnecessary token consumption.
