...
<body class="bg-[#0B0B0F] text-[#D1D5DB] font-sans min-h-screen flex flex-col antialiased selection:bg-[#6D28D9] selection:text-white"
    ...
    <header class="h-14 border-b border-[#1F1F2E] bg-[#0E0E14] sticky top-0 z-40 px-6 flex items-center justify-between text-xs font-mono">
        ...
        <div class="flex items-center gap-4">
            <a href="{{ route('cms.dashboard') }}" class="flex items-center gap-2.5 font-serif font-bold text-base text-white hover:text-[#8B5CF6] transition-colors">
                <img src="{{ asset('images/logo.png') }}" alt="Daily AI World Logo" class="w-6 h-6 rounded-full object-cover ring-1 ring-purple-500/40 shrink-0">
    ...
    <div class="flex-grow flex">
        ...
        <aside class="w-64 border-r border-[#1F1F2E] bg-[#0E0E14] flex flex-col justify-between py-6 px-4 shrink-0 text-xs font-medium">
            <div class="space-y-6">
                ...
                <!-- Section 3: Revenue Architecture -->
                <div>
                    <span class="px-3 text-[10px] font-mono uppercase tracking-widest font-bold block mb-2 text-emerald-400">Revenue & Monetization</span>
                    <nav class="space-y-1">
                        <a href="{{ route('cms.monetization') }}" class="{{ request()->routeIs('cms.monetization') ? 'bg-[#1E1B2E] text-[#C4B5FD] font-semibold border-l-2 border-[#8B5CF6]' : 'text-gray-400 hover:bg-[#161622] hover:text-white' }} px-3 py-2 rounded-r-md flex items-center gap-2.5 transition-colors">
                            <svg class="w-4 h-4 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                            <span>Executive Revenue</span>
                        </a>

                        <a href="{{ route('cms.sponsors') }}" class="{{ request()->routeIs('cms.sponsors') ? 'bg-[#1E1B2E] text-[#C4B5FD] font-semibold border-l-2 border-[#8B5CF6]' : 'text-gray-400 hover:bg-[#161622] hover:text-white' }} px-3 py-2 rounded-r-md flex items-center gap-2.5 transition-colors">
                            <svg class="w-4 h-4 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/></svg>
                            <span>Sponsor CRM</span>
                        </a>

                        <a href="{{ route('cms.subscriptions') }}" class="{{ request()->routeIs('cms.subscriptions') ? 'bg-[#1E1B2E] text-[#C4B5FD] font-semibold border-l-2 border-[#8B5CF6]' : 'text-gray-400 hover:bg-[#161622] hover:text-white' }} px-3 py-2 rounded-r-md flex items-center gap-2.5 transition-colors">
